...
/* Remove this line to enable Rotation Lock button to toggle touch on/off

SC127::
{
RegRead, TouchStatus, HKEY_CURRENT_USER, Software\Microsoft\Wisp\Touch, TouchGate
If TouchStatus = 0 ;Touch Off
	{
		RegWrite, REG_DWORD, HKEY_CURRENT_USER, Software\Microsoft\Wisp\Touch, TouchGate, 1
	}
Else ;Touch On
